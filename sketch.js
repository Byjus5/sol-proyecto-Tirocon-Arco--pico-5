...
function draw() {
 ...
 //Usar loop for para mostrar la flecha usando la función showArrow() 
...
//Llamar funciones para detectar colisión para el jugador y la computadora 
...
function keyPressed() {
  ...
  if(keyCode === 32){
    // crear un objeto de flecha y agregarlo a la matriz ; establecer su ángulo igual que el de playerArcher
...
function keyReleased () {
  ...
  if(keyCode === 32){
    //llamar a la función shoot() por cada flecha en la matriz playerArrows
...
//Escribir código para detectar colisión entre la flecha del jugador y el oponente
}
